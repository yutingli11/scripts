...
const imax = {
    ...
    css: {
        ...
        button_common:
            ...
            "border-right: 6px solid #38a3fd !important; " +
            "border-left: #292f33 !important; " +
            "border-top: #292f33 !important; " +
            "border-bottom: #292f33 !important; " +
            "background: #2563eb; " +
...
function adsDomain_switch(x) { // 匹配参数值 执行相应函数
    switch (x) {
        case 'pornhub':
            ...
            const custom_style_values_pb = "right: 0px !important; background: red !important; position: relative !important;"
            button_dynamicAppend("h1.floatLeft,div.title-container.translate", "如何下载视频", custom_style_values_pb, imax.css.button_common, "window.open(\"https://limbopro.com/archives/M3U8-Downloader.html\", \"_blank\")", "download_pornhub", 2)
            pornhub_sidebar_ads();
            break;
        case 'missav':
            ...
            if (ua_missav.indexOf(mobile_missav) === -1) {
                button_dynamicAppend("div.mt-4", "离开页面视频继续播放", custom_style_values_miss, imax.css.button_common, "video_loopPlay()", "missavX", 2);
                button_dynamicAppend("div.mt-4", "如何下载视频", custom_style_values_miss, imax.css.button_common, "window.open(\"https://limbopro.com/archives/M3U8-Downloader.html\", \"_blank\")", "how", 3);
                // 添加监听器
                addListenerById("missavX", () => { video_loopPlay() }, 1000);
            } else if (ua_missav.indexOf(mobile_missav) > -1) {
                button_dynamicAppend("div.mt-4", "免广告播放", custom_style_values_miss, imax.css.button_common, "video_Play()", "missavX", 0);
                button_dynamicAppend("div.mt-4", "进入全屏", custom_style_values_miss, imax.css.button_common, "fullscreen()", "missavFullScreen", 2);
                button_dynamicAppend("div.mt-4", "暂停", custom_style_values_miss, imax.css.button_common, "video_pause()", "missavPause", 1);
                button_dynamicAppend("div.mt-4", "如何下载视频", custom_style_values_miss, imax.css.button_common, "window.open(\"https://limbopro.com/archives/M3U8-Downloader.html\", \"_blank\")", "how", 3);
                // 添加监听器
        ...
        case 'jable':
            ...
            button_dynamicAppend("div h4", "获取M3U8文件", custom_style_values_jb_pc, imax.css.button_common, "", "jablex", 1)
            button_dynamicAppend("div h4", "如何下载视频", custom_style_values_jb_pc, imax.css.button_common, "window.open(\"https://limbopro.com/archives/M3U8-Downloader.html\", \"_blank\")", "how", 2);
            // 添加监听器
            addListenerById("jablex", () => { repeat_regex.forEach(m3u8_tempt) }, 1000);
        ...
        case 'bdys':
            ...
            if (url == "https://www.bdys01.com/") {
                if (!document.getElementById("bdys")) {
                    button_dynamicAppend("div.container-xl", "隐藏公告", "position:inherit; right:92px;", imax.css.button_common, "", "bdys", 1);
...
function button_dynamicAppend(ele, innerText, custom_style_values, common_style_values, func, id, array) {
    let button = document.createElement("button");
    button.innerHTML = innerText;
    button.setAttribute("onclick", func);
    button.setAttribute("id", id);
    button.setAttribute("style", custom_style_values + common_style_values);
